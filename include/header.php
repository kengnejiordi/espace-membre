<!doctype html>
<html class="h-100" data-bs-theme="auto" lang="fr">
<head>
    ...
    <style>
        @import url('https://fonts.googleapis.com/css2?family=Nunito:ital,wght@1,1000&display=swap');

        body {
            background: linear-gradient(to right, #ffffff, #7d8d99);
        }
...
<div class="dropdown position-fixed bottom-0 end-0 mb-3 me-3 bd-mode-toggle">
    <button aria-expanded="false"
            ...
            class="btn btn-light py-2 dropdown-toggle d-flex align-items-center rounded"
...
<div class="container d-flex w-100 h-100 p-2 mx-auto flex-column">
    <header class="mb-auto">
        <div class="navbar border-0 ">
            <h3 class="float-md-start mb-0">Jiordi_Viera</h3>
            <nav class="nav nav-masthead justify-content-center float-md-end navbar-expand-sm">
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-bs-title="ceci est ma navbar"
                ...
                // Vérifie si l'utilisateur est connecté (utilisez votre propre logique de connexion)
                # $user = false;

                if (isset($_SESSION['id'])) {
                    //echo 'Bonjour ' . $_SESSION['username'];
                    // Affiche le menu pour utilisateur connecté
                    include_once 'header_connecte.php';
                } else {
                    include_once 'header_non_connecte.php';
                }
                ?>
